            ...
            <div className="container mx-auto px-8 md:px-16 h-full flex flex-col justify-between pt-40 pb-16">
                ...
                <div className="max-w-4xl">
                    <motion.div
                        ...
                        className="mb-8"
                    >
                        <h1 className="text-5xl md:text-8xl font-bold leading-tight md:leading-none mb-6">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="pointer-events-auto px-8 py-4 bg-white text-black font-semibold rounded-full hover:bg-gradient-to-r hover:from-cyan-400 hover:to-blue-600 hover:text-white transition-all duration-300"
                    >
                        EXPLORE OUR WORK
                    </motion.button>
                </div>
