...
const Navbar = ({ isDark, toggleTheme }) => {
    ...
    return (
        <nav className={`fixed top-0 z-50 w-full backdrop-blur-xl border-b shadow-lg transition-colors duration-300 ${isDark ? 'bg-black/40 border-white/10' : 'bg-white/70 border-gray-200'}`}>
                        ...
                        {navLinksLeft.map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className={`px-3 py-2 rounded-md text-lg font-semibold tracking-wide transition-all duration-300 hover:shadow-[0_0_10px_rgba(59,130,246,0.5)] ${isActive
                                        ? 'text-blue-400 shadow-[0_0_10px_rgba(59,130,246,0.5)]'
                                        : isDark ? 'text-white/90 hover:text-blue-400' : 'text-gray-700 hover:text-blue-600'
                                        }`}
                                >
                                    {item}
                                </Link>
