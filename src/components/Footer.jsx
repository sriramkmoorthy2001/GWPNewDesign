...
import darkImg from "/gwp-b.webp";
import lightImg from "/gwp-w.webp";

const Footer = ({ isDark }) => {
  return (
    <footer
      className={`relative pt-0 pb-10 px-8 md:px-16 ${
        isDark ? "bg-slate-950 text-gray-400" : "bg-gray-200/50 text-gray-600"
      }`}
    >
      <div className="max-w-[1400px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 pt-16 mb-16">
          <div className={`flex justify-start ${isDark ? 'w-48 h-28': 'w-44 h-28'} lg:mx-8`}>
            <img
          ...
          {/* Links Grid */}
          <div className="flex-grow grid grid-cols-2 md:grid-cols-5 gap-8 text-sm">
            {/* Column 1: Company */}
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#" className="hover:text-blue-400 block">
                    Home
                  </a>
                </li>
                <li>
                ...
                <li>
                  <Link to="/contact" className="hover:text-blue-400 block">
                    Contact us
                  </Link>
                </li>
                <li>
            ...
            {/* Column 3: Services 2 */}
            <div className="space-y-4">
              {/* Spacer for alignment to match visual if needed, or just list */}
        ...
        <div className="border-t border-gray-700/50 pt-8 flex flex-col md:flex-row justify-between items-end gap-8">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex gap-4">
              <a
                href="#"
                className={`p-2 rounded bg-white text-blue-900 hover:scale-110 transition-transform`}
              >
                <Linkedin
                  size={24}
                  fill="currentColor"
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                >
                  ...
                  {/* Simplified stars as dots for small size */}
                  <path
